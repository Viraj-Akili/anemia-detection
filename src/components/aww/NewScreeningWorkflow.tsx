          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-[14px] text-[#6e6e73]">
                Target: <strong className="text-[#1d1d1f]">{cameraRoiRegion}</strong> for {beneficiary?.name}
              </p>
            </div>
        ...
        <div className="bg-white rounded-[32px] p-8 border border-black/[0.06] shadow-sm space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-[#fbfbfd] p-5 rounded-2xl border border-black/[0.06] space-y-1">
              ...
              <p className="text-[11px] text-[#86868b]">Optical Mucosal Pallor</p>
            </div>
            ...
            <div className="bg-[#fbfbfd] p-5 rounded-2xl border border-black/[0.06] space-y-1">
              ...
              <p className="text-[11px] text-[#86868b]">WHO Anthropometry</p>
            </div>
            ...
            <div className="bg-[#fbfbfd] p-5 rounded-2xl border border-black/[0.06] space-y-1">
              ...
              <p className="text-[11px] text-[#86868b]">Priority Level</p>
            </div>
          </div>
          ...
          {screeningResult.triggeredSafetyRules.length > 0 && (
            <div className="bg-red-50/80 border border-red-200 rounded-2xl p-5 text-[12px] text-red-900 space-y-1">
              <div className="flex items-center gap-2 font-semibold text-red-800 text-[13px]">
                ...
                <span>Deterministic Clinical Safety Safeguard Enforced</span>
              </div>
          ...
          <div className="space-y-3">
            <h4 className="text-[15px] font-semibold text-[#1d1d1f]">Contributing Signals & Explainability</h4>
          ...
          <div className="bg-[#f5f5f7] p-6 rounded-2xl border border-black/[0.05] space-y-3">
