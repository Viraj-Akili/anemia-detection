...
interface OpticalCaptureZoneProps {
  ...
  onChangeRoi?: (roi: 'Palpebral Conjunctiva') => void;
  capturedImage: string | null;
  onImageCaptured: (imageUri: string | null) => void;
  onImageFileCaptured?: (file: File | null) => void;
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <h2 className="text-[26px] font-semibold text-[#1d1d1f] tracking-title mt-0.5">
            Capture Conjunctival Image
          </h2>
          <p className="text-[14px] text-[#6e6e73]">
            Upload or capture a close-up photo of the palpebral conjunctiva (lower inner eyelid) in natural light.
          </p>
        </div>
          ...
          <div className="p-8 text-center space-y-4 max-w-sm">
            ...
            <div className="space-y-1">
              <h4 className="text-[16px] font-semibold text-white">
                Target: Palpebral Conjunctiva (Lower Eyelid Mucosa)
              </h4>
